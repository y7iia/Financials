...
st.markdown('برنامج يقيم أداء توصيات المحللين الماليين والفنيين بعد اشراتهم لسهم معين. البرنامج يحدد إن كانت الأسعار قد وصلت الى الأهداف المحددة أم لا مع تقرير عن العائد على السهم.')
