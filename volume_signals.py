...
<sub>
هذا التطبيق يقوم بجلب بيانات الأسهم لقطاع محدد من السوق السعودي، ويحسب عدد المرات التي تجاوز فيها الحجم اليومي للتداول القيمة المتوسطة المتحركة للحجم (EMA) على مدى 90 يومًا، مع الأخذ في الاعتبار أن السعر الختامي كان أقل من السعر الأعلى في الـ 90 يومًا الأخيرة. يقدم التطبيق أيضًا إمكانية اختيار الفترة الزمنية للبيانات المحدثة.
</sub>
